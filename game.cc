...
void Game::UpdateScreen() {
  ...
  if (HasLost()) {
    ...
    gameScreen_.DrawRectangle(210, gameScreen_.GetHeight() * 0.5 + 30, 200 , 110, lightGreen);
    gameScreen_.DrawText(270, gameScreen_.GetHeight() * 0.5 + 40, "PLAY", 50, black);
    gameScreen_.DrawText(250, gameScreen_.GetHeight() * 0.5 + 85, "AGAIN", 50, black);
    gameScreen_.DrawRectangle(510, gameScreen_.GetHeight() * 0.5 + 30, 200 , 100, red);
    gameScreen_.DrawText(560, gameScreen_.GetHeight() * 0.5 + 50, "QUIT", 60, black);
